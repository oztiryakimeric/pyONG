...
from game.consumers import ws_connect, ws_receive, ws_disconnect, join, paddle_update, border_collision
...
custom_routing = [
    ...
    route("websocket.receive", border_collision, command="^border_collision"),
]
